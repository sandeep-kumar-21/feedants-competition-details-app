 ...
 * It moves or deletes files in the /src/app directory and creates new index.tsx and _layout.tsx files.
 */
...
const oldDirs = ["src/app", "src/components", "src/hooks", "src/constants"];
const exampleDir = "src/app-example";
